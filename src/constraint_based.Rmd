...
export_path <- paste0(getwd(), "/dags/")

# Define file paths
l30_hist <- paste0(data_path, "osd_310/LSDS-30_histomorphometry_turnerTRANSFORMED.csv")
l9_micro <- paste0(data_path, "osd_351/LSDS-9_microCT_turnerTRANSFORMED.csv")
...
l15_micro <- paste0(data_path, "osd_489/LSDS-15_microCT_alwoodTRANSFORMED.csv")
l41_tomo <- paste0(data_path, "osd_608/LSDS-41_peripheral_quantitative_computed_tomography_pQCT_LSDS-41_pQCT_KoTRANSFORMED.csv")
```
