...
plot_title <- paste0("Fast IAMB 😲🐭 ", title)
plot(fast_iamb_graph, attrs = list(graph = graph_attrs, node = node_attrs, edge = edge_attrs))
title(plot_title, line = -4, cex.main = 2)

plot_title <- paste0("Inter IAMB 😲🐭 ", title)
plot(inter_iamb_graph, attrs = list(graph = graph_attrs, node = node_attrs, edge = edge_attrs))
title(plot_title, line = -4, cex.main = 2)

plot_title <- paste0("IAMB FDR 😲🐭 ", title)
plot(iamb_fdr_graph, attrs = list(graph = graph_attrs, node = node_attrs, edge = edge_attrs))
title(plot_title, line = -4, cex.main = 2)
```